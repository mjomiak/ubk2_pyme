...
{!! MigasFacade::render('ubk2/ara/update') !!}
<div class="row" style="margin-top: 1em;">
    ...
    <form action="{{route('Ubk2GuardarEdicionArea')}}" method="post">
        @csrf

        <input type="hidden" name="id_area" name="id_area" value="{{$area->id_area}}">
        <input type="hidden" name="id_cliente" name="id_cliente" value="{{$area->id_cliente}}">

    <div class="card">
        <div class="card-header"><b>Editar Área</b></div>
        <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nombre_area') is-invalid @enderror" id="nombre_area"
                name="nombre_area" value="{{$area->nombre}}" required autocomplete="off"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('descrip_area') is-invalid @enderror"
                id="descrip_area" name="descrip_area" value="{{ $area->descrip}}" required
